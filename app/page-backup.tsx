        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass p-8 rounded-2xl card-glow">
              <div className="w-12 h-12 bg-[#97F11D]/20 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-[#97F11D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 text-xl font-semibold text-white mb-4 md:mb-0">
              <span className="text-[#97F11D]">Flow</span>Pay
            </div>
